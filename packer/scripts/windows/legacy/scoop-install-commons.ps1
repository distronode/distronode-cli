...
# https://github.com/distronode-project/k-NN/issues/829#issuecomment-1499846457
...
$ref = "main"
$JSON_BASE = "https://raw.githubusercontent.com/distronode-project/DistroNode-Dashboards/$ref/package.json"
...
# The distronode-dashboards-functional-test repo can still run tests
# as cypress will be installed globally by `npm install` when running integtest.sh
# https://github.com/distronode-project/distronode-ci/issues/297
