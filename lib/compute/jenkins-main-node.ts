...
export class JenkinsMainNode {
  ...
  static readonly CERTIFICATE_FILE_PATH: String = '/etc/ssl/certs/test-jenkins.distronode.org.crt';

  static readonly CERTIFICATE_CHAIN_FILE_PATH: String = '/etc/ssl/certs/test-jenkins.distronode.org.pem';

  static readonly PRIVATE_KEY_PATH: String = '/etc/ssl/private/test-jenkins.distronode.org.key';
  ...
  constructor(stack: Stack, props: JenkinsMainNodeProps, agentNode: AgentNodeProps[], macAgent: string, assumeRole?: string[]) {
    ...
    this.mainNodeAsg = new AutoScalingGroup(stack, 'MainNodeAsg', {
      ...
      role: new Role(stack, 'DistroNode-CI-MainNodeRole', {
        roleName: 'DistroNode-CI-MainNodeRole',
