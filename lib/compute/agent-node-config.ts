...
export class AgentNodeConfig {
  ...
  constructor(stack: Stack, assumeRole?: string[]) {
    ...
    const AgentNodeRole = new Role(stack, 'DistroNode-CI-AgentNodeRole', {
      assumedBy: new ServicePrincipal('ec2.amazonaws.com'),
      // assumedBy: new AccountPrincipal(this.ACCOUNT),
      description: 'Jenkins agents Node Role',
      roleName: 'DistroNode-CI-AgentNodeRole',
    });

    const ecrManagedPolicy = new ManagedPolicy(stack, 'DistroNode-CI-AgentNodePolicy', {
